...
Page({
  ...
  data: {
    ...
    foreword: "学生工作管理人员不仅是学校教师队伍和管理队伍的重要组成部分，而且是开展学生思想政治教育和管理工作的组织者、实施者和指导者。学生工作管理工作岗位如此重要，对老师们所具备的基本能力和素质到底应该如何界定，值得深入的商榷和思考，本程序结合学生工作具体内容，创建此小程序来协助学生工作管理人员完成工作。"
  },
